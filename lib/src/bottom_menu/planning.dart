    ...
    try {
      ...
      if (jsonResponse['statusCode'] == 200) {
        setState(() {
          ...
          print(_userTrainingData);
          // print(List.from(ref.read(userTrainingDataProvider).keys));

          // リストを初期化しておく
          // List result_tp = List.from(_userTrainingData.keys);
          // for (int i = 0; i < _userTrainingData.length; i++) {
          //   var key = result_tp[i];
          //   _registeredPlanList.add(
          //     {
          //       'plan_id': key,
          //       'plan_title': _userTrainingData[key]['training_plan_name'],
          //       'plan_description': _userTrainingData[key]['training_plan_description'] == '' ? plan_not_registered : _userTrainingData[key]['training_plan_description'],
          //       'plan_counts': _userTrainingData[key]['count'].toString(),
          //     },
          //   );
          // }
          // // 追加ボタンのカード用
          // _registeredPlanList.add(
          //   {"plan_id": null, "plan_title": null, "plan_description": null, "plan_counts": 0},
          // );
          // // Providerの変数に保存しておく
